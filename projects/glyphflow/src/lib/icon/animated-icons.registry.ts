...
const icon = (shapes: IconShape[], animations: Record<string, IconChoreography>): AnimatedIconDef => ({
  shapes,
...
export const historyIcon: AnimatedIconDef = /* @__PURE__ */ icon(historyShapes, {
    default: {
...
export const wifiIcon: AnimatedIconDef = /* @__PURE__ */ icon(wifiShapes, {
    default: {
      shapes: {
        0: /* @__PURE__ */ track(/* @__PURE__ */ burst(), 320),
        3: /* @__PURE__ */ track(/* @__PURE__ */ burst(), 380, { delay: 130 }),
        2: /* @__PURE__ */ track(/* @__PURE__ */ burst(), 380, { delay: 260 }),
        1: /* @__PURE__ */ track(/* @__PURE__ */ burst(), 380, { delay: 390 }),
      },
    },
  });
...
export const facebookIcon: AnimatedIconDef = /* @__PURE__ */ icon(facebookShapes, {
    default: { root: /* @__PURE__ */ track(/* @__PURE__ */ scaleSeq([1, 1.12, 1]), 420, { easing: SPRING_OUT, origin: 'center' }) },
  });

/** Instagram: el lente late y el flash destella. */
export const instagramIcon: AnimatedIconDef = /* @__PURE__ */ icon(instagramShapes, {
    default: {
      shapes: {
        1: /* @__PURE__ */ track(/* @__PURE__ */ scaleSeq([1, 1.12, 1]), 450, { origin: '12px 12px' }),
        2: /* @__PURE__ */ track(/* @__PURE__ */ burst(), 350, { delay: 200 }),
      },
    },
  });

export const linkedinIcon: AnimatedIconDef = /* @__PURE__ */ icon(linkedinShapes, {
    default: {
      shapes: {
        0: /* @__PURE__ */ track(/* @__PURE__ */ burst(), 380),
        1: /* @__PURE__ */ track(/* @__PURE__ */ burst(), 380, { delay: 100 }),
        2: /* @__PURE__ */ track(/* @__PURE__ */ burst(), 380, { delay: 180 }),
      },
    },
  });
...
export const twitterIcon: AnimatedIconDef = /* @__PURE__ */ icon(twitterShapes, {
    default: {
      root: /* @__PURE__ */ track(
        [
...
// @__PURE__ es obligatorio aquí: sin él, esbuild trata Object.keys() como una llamada con
// posibles efectos secundarios y NUNCA la elimina aunque ANIMATED_ICON_NAMES no se use — y como
// referencia a ANIMATED_ICONS, eso ancla el registro completo (los 184 iconos) en cualquier build
// que use aunque sea un solo icono. Verificado con una reproducción mínima en esbuild directo.
